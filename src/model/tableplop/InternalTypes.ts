...
export type ChildProperty = Message | Text | NumberProp | Health | Appearance | TitleSection | Checkbox | Checkboxes | Paragraph | Ability | SavingThrow | Skill | Skill4 | HorizontalSection;
