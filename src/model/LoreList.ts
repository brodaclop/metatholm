export const Lore: Record<string, Record<string, Promise<typeof import("*?raw")>>> = {
	hu: {
		...
		'action:hidden-weapon': import('$lib/lore/action/hidden-weapon_hu.md?raw'),
		'action:keep-away': import('$lib/lore/action/keep-away_hu.md?raw'),
		'action:keep-close': import('$lib/lore/action/keep-close_hu.md?raw'),
		'action:knockout': import('$lib/lore/action/knockout_hu.md?raw'),
		'action:spin-behind': import('$lib/lore/action/spin-behind_hu.md?raw'),
		'action:step-in': import('$lib/lore/action/step-in_hu.md?raw'),
		'action:step-out': import('$lib/lore/action/step-out_hu.md?raw'),
		'action:trip': import('$lib/lore/action/trip_hu.md?raw'),
		...
		'background:rover': import('$lib/lore/background/rover_hu.md?raw'),
		...
		'notes:death': import('$lib/lore/notes/death_hu.md?raw'),
		'notes:vagueness': import('$lib/lore/notes/vagueness_hu.md?raw'),
		'rule:changes': import('$lib/lore/rule/changes_hu.md?raw'),
		...
		'skill:magic_resistance': import('$lib/lore/skill/magic_resistance_hu.md?raw'),
		...
		'skill:shields': import('$lib/lore/skill/shields_hu.md?raw'),
		...
		'skill:tinkering': import('$lib/lore/skill/tinkering_hu.md?raw'),
		'skill:trick_fighting': import('$lib/lore/skill/trick_fighting_hu.md?raw'),
		...
		'spell:insignificance': import('$lib/lore/spell/insignificance_hu.md?raw'),
		...
		'spell:shrink': import('$lib/lore/spell/shrink_hu.md?raw'),
		'spell:silence_of_forests': import('$lib/lore/spell/silence_of_forests_hu.md?raw'),
		'spell:slow_metabolism': import('$lib/lore/spell/slow_metabolism_hu.md?raw'),
		...
		'spell:suspended_animation': import('$lib/lore/spell/suspended_animation_hu.md?raw'),
		'spell:sustenance': import('$lib/lore/spell/sustenance_hu.md?raw'),
		'spell:tapestry_of_flame': import('$lib/lore/spell/tapestry_of_flame_hu.md?raw'),
		...
		'world:realms:deep_kingdom:realm': import('$lib/lore/world/realms/deep_kingdom/realm_hu.md?raw'),
		'world:realms:dragon_straits:realm': import('$lib/lore/world/realms/dragon_straits/realm_hu.md?raw'),
		'world:realms:dragon_straits:organisations:ferrymen': import('$lib/lore/world/realms/dragon_straits/organisations/ferrymen_hu.md?raw'),
		...
		'world:realms:dragon_straits:settlements:oakvale': import('$lib/lore/world/realms/dragon_straits/settlements/oakvale_hu.md?raw'),
		...
		'world:realms:foxfire:realm': import('$lib/lore/world/realms/foxfire/realm_hu.md?raw'),
	...
	en: {
		...
		'action:hidden-weapon': import('$lib/lore/action/hidden-weapon_en.md?raw'),
		'action:keep-away': import('$lib/lore/action/keep-away_en.md?raw'),
		'action:keep-close': import('$lib/lore/action/keep-close_en.md?raw'),
		'action:knockout': import('$lib/lore/action/knockout_en.md?raw'),
		'action:spin-behind': import('$lib/lore/action/spin-behind_en.md?raw'),
		'action:step-in': import('$lib/lore/action/step-in_en.md?raw'),
		'action:step-out': import('$lib/lore/action/step-out_en.md?raw'),
		'action:trip': import('$lib/lore/action/trip_en.md?raw'),
		...
		'background:rover': import('$lib/lore/background/rover_en.md?raw'),
		...
		'notes:death': import('$lib/lore/notes/death_en.md?raw'),
		'notes:vagueness': import('$lib/lore/notes/vagueness_en.md?raw'),
		'rule:changes': import('$lib/lore/rule/changes_en.md?raw'),
		...
		'skill:magic_resistance': import('$lib/lore/skill/magic_resistance_en.md?raw'),
		...
		'skill:shields': import('$lib/lore/skill/shields_en.md?raw'),
		...
		'skill:tinkering': import('$lib/lore/skill/tinkering_en.md?raw'),
		'skill:trick_fighting': import('$lib/lore/skill/trick_fighting_en.md?raw'),
		'spell:blunt_senses': import('$lib/lore/spell/blunt_senses_en.md?raw'),
		'spell:borrow_time': import('$lib/lore/spell/borrow_time_en.md?raw'),
		'spell:call_animals': import('$lib/lore/spell/call_animals_en.md?raw'),
		'spell:cleaning': import('$lib/lore/spell/cleaning_en.md?raw'),
		'spell:cloak_of_shadow': import('$lib/lore/spell/cloak_of_shadow_en.md?raw'),
		'spell:commune_with_spirits': import('$lib/lore/spell/commune_with_spirits_en.md?raw'),
		'spell:convert_life_to_magic': import('$lib/lore/spell/convert_life_to_magic_en.md?raw'),
		'spell:darken': import('$lib/lore/spell/darken_en.md?raw'),
		'spell:drain_magic': import('$lib/lore/spell/drain_magic_en.md?raw'),
		'spell:extinguish_fire': import('$lib/lore/spell/extinguish_fire_en.md?raw'),
		'spell:extinguish_magic': import('$lib/lore/spell/extinguish_magic_en.md?raw'),
		'spell:farsight': import('$lib/lore/spell/farsight_en.md?raw'),
		'spell:fire_arrow': import('$lib/lore/spell/fire_arrow_en.md?raw'),
		'spell:flameball': import('$lib/lore/spell/flameball_en.md?raw'),
		'spell:fool_senses': import('$lib/lore/spell/fool_senses_en.md?raw'),
		'spell:hardened_skin': import('$lib/lore/spell/hardened_skin_en.md?raw'),
		'spell:heal': import('$lib/lore/spell/heal_en.md?raw'),
		'spell:heat_material': import('$lib/lore/spell/heat_material_en.md?raw'),
		'spell:insignificance': import('$lib/lore/spell/insignificance_en.md?raw'),
		'spell:iron_fist': import('$lib/lore/spell/iron_fist_en.md?raw'),
		'spell:jump': import('$lib/lore/spell/jump_en.md?raw'),
		'spell:lantern': import('$lib/lore/spell/lantern_en.md?raw'),
		'spell:lend_life': import('$lib/lore/spell/lend_life_en.md?raw'),
		'spell:light_fire': import('$lib/lore/spell/light_fire_en.md?raw'),
		'spell:lightning_strike': import('$lib/lore/spell/lightning_strike_en.md?raw'),
		'spell:magic_bolt': import('$lib/lore/spell/magic_bolt_en.md?raw'),
		'spell:maintain_body_temperature': import('$lib/lore/spell/maintain_body_temperature_en.md?raw'),
		'spell:message': import('$lib/lore/spell/message_en.md?raw'),
		'spell:read_emotions': import('$lib/lore/spell/read_emotions_en.md?raw'),
		'spell:sense_life': import('$lib/lore/spell/sense_life_en.md?raw'),
		'spell:sense_poison': import('$lib/lore/spell/sense_poison_en.md?raw'),
		'spell:shadow_leap': import('$lib/lore/spell/shadow_leap_en.md?raw'),
		'spell:shelter': import('$lib/lore/spell/shelter_en.md?raw'),
		'spell:shout': import('$lib/lore/spell/shout_en.md?raw'),
		'spell:shrink': import('$lib/lore/spell/shrink_en.md?raw'),
		'spell:silence_of_forests': import('$lib/lore/spell/silence_of_forests_en.md?raw'),
		'spell:slow_metabolism': import('$lib/lore/spell/slow_metabolism_en.md?raw'),
		'spell:spirit_shroud': import('$lib/lore/spell/spirit_shroud_en.md?raw'),
		'spell:steel_will': import('$lib/lore/spell/steel_will_en.md?raw'),
		'spell:strike_from_afar': import('$lib/lore/spell/strike_from_afar_en.md?raw'),
		'spell:suppress_pain': import('$lib/lore/spell/suppress_pain_en.md?raw'),
		'spell:suspended_animation': import('$lib/lore/spell/suspended_animation_en.md?raw'),
		'spell:sustenance': import('$lib/lore/spell/sustenance_en.md?raw'),
		'spell:tapestry_of_flame': import('$lib/lore/spell/tapestry_of_flame_en.md?raw'),
		'spell:telekinesis': import('$lib/lore/spell/telekinesis_en.md?raw'),
		'spell:thicket': import('$lib/lore/spell/thicket_en.md?raw'),
		...
		'world:concepts:character': import('$lib/lore/world/concepts/character_en.md?raw'),
		...
		'world:realms:crows_domain:realm': import('$lib/lore/world/realms/crows_domain/realm_en.md?raw'),
		...
		'world:realms:dragon_straits:settlements:oakvale': import('$lib/lore/world/realms/dragon_straits/settlements/oakvale_en.md?raw'),
		...
		'world:realms:foxfire:realm': import('$lib/lore/world/realms/foxfire/realm_en.md?raw'),
